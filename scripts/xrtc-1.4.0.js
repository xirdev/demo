...
(function(exports) {
  ...
  xrtc.AuthManager.extend({events:{serverError:"servererror"}, settings:{unsuccessfulRequestRepeatTimeout:5E3, tokenHandler:"https://service.xirsys.com/getToken", iceHandler:"https://service.xirsys.com/getIceServers"}});
})(window);
...
(function(exports) {
  ...
  xrtc.Class(xrtc, "Room", function Room(info, am, sc) {
    ...
    function onIncomingConnection(data) {
      ...
      var self = this;
      var incomingConnectionData = {user:getUserById(data.senderId)};
